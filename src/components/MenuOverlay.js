...
import "../stylesheets/MenuOverlay.css";
      ...
      <div className={`menu-overlay ${menuOpen ? "show" : ""}`}>
        ...
        <div className="menu-logo">
          <Link to="/" onClick={toggleMenu}>
            <svg
              id="navLogo"
              alt="Joint Amsterdam Logo"
              className="menuLogoImage"
              viewBox="0 0 220.58 34.62"
            >
              <defs>
                <style>{`.cls-1 { fill: currentColor; }`}</style>
              </defs>
        ...
        {/* Right Column: Dark Mode + Menu Links */}
        <div className="menu-right-column">
          <div className="menu-links">
            ...
            <a href="mailto:###?Subject=Hi%20there!" onClick={toggleMenu}>contact</a>
          </div>
        </div>
      </div>
    </>
